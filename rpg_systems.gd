...
const ITEMS := {
	...
	# XENOREACH souvenirs/trophies (kills + landmarks — viewable in the PACK)
	"trophy_skarn":    {"name": "Skarn Acid Gland", "type": "souvenir"},
	"trophy_veyth":    {"name": "Veyth Shroud Husk", "type": "souvenir"},
	"trophy_gorra":    {"name": "Gorra Horn", "type": "souvenir"},
	"trophy_mylah":    {"name": "Mylah Sigil Stone", "type": "souvenir"},
	"trophy_broodmaw": {"name": "Broodmaw Heart", "type": "souvenir"},
	"trophy_relic":    {"name": "Precursor Relic", "type": "souvenir"},
	"trophy_skull":    {"name": "Ancient Skull", "type": "souvenir"},
	"trophy_idol":     {"name": "Glowing Idol", "type": "souvenir"},
}
